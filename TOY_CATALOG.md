...
| 5 | 陀螺 | `top` | 程序化圆锥、圆环与手柄 | 项目原创 | Box 3 |
| 6 | 礼物盒 | `gift` | 程序化盒体、缎带与蝴蝶结 | 项目原创 | Box 4 |
...
- Box 2：4 类基础玩具，共 12 件，练习优先凑齐一组。
- Box 3：8 类机器人、太空、车辆与陀螺玩具，共 24 件。
- Box 4：9 类高辨识度玩具，共 27 件，加入街机、火车、礼物与食物玩具。
